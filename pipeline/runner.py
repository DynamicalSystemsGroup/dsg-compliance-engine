...
from ontology.prefixes import CE, CMMC, EARL, G_ORDER
from pipeline.dataset import create_dataset, graph_for, load_into
from pipeline.plan_execution import emit_stage_activity
...
from evidence.hashing import _serialize_for_hash, hash_structural_model
...
try:  # pragma: no cover - CLI wiring
    ...
    def run(
        ...
        chdir: Annotated[str, typer.Option(
            "--tf-chdir", help="Terraform dir.")] = "terraform/tier1",
