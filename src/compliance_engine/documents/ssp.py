...
if TYPE_CHECKING:
    from compliance_engine.traceability.audit import AuditReport
    from compliance_engine.traceability.bom import BOM

from compliance_engine.ontology.prefixes import NAMED_GRAPHS
from compliance_engine.traceability.attestation import STATUS_LABEL
from compliance_engine.documents.queries import (
    ATTESTATION_DETAIL,
...
def _compile_with_optional_audit(ds: Dataset, input: Path, audit: bool) -> str:
    ...
    try:
        from compliance_engine.traceability.audit import audit as run_audit
